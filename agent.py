...
class Agent:
    def __init__(self,function=fn.eggholder,bounds=[(-512, 512), (-512, 512)],my_id=1):
        self.__id = my_id
        self.__initial_position = [np.random.uniform(low=bounds[0][0],high=bounds[0][1]),np.random.uniform(low=bounds[1][0],high=bounds[1][1])]
